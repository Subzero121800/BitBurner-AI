...
function buildPrompt(state, safety) {
  return [
    ...
    "- Example sleeve plan: {default:{task:'commit_crime',crime:'Homicide'},sleeves:{0:{task:'synchronize'},1:{task:'study',course:'Algorithms'},2:{task:'gym',stat:'strength'},3:{task:'bladeburner',type:'Contract',name:'Tracking'},4:{task:'travel',city:'Aevum'},5:{task:'buy_aug',aug:'Augmented Targeting I'}}}",
